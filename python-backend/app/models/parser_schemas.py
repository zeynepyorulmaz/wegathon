"""
Schemas for prompt parsing - converts natural language to structured travel data.
"""
...
class ParsedTripPrompt(BaseModel):
    """Structured output from parsing a natural language travel request."""
    departure: Departure
...
class ParsePromptRequest(BaseModel):
    """Request to parse a natural language travel prompt."""
